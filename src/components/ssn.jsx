...
const SSN = () => {
  return (
    ...
    <h1 className='text-3xl text-center p-4 font-bold mt-5 border-b-2' >Routes</h1>

    <div className='mr-4 ml-4'>
    <p className='text-md text-justify p-4 mt-5 bg-slate-300 rounded-lg mb-5'><strong className='text-xl'>Route 1:</strong> <br></br>
For Participants who arrive by Train to Egmore Station For those who are coming from South Tamil Nadu, it is informed that all the trains going to Chennai Egmore station stop at Tambaram. Tambaram bus stand is adjacent to Tambaram Railway station.
Those who are coming from south Tamil Nadu by bus also can get down at Perungulathur and then they can cross the road to reach the bus stop and take the following buses: Route no. from Tambaram to SSN College of Engineering: Route no.: 515 & 115 - Mamallapuram Route no. : 555, 55K & 566 – Thirupporur These buses will reach SSN college of Engineering via Tambaram and Perungulathur. It takes about 45-55 minutes to reach SSN College.
</p>
...
<div style={{ width: '98%' }} className="rounded-xl ml-4 mx-auto mb-8">
      <iframe
        ...
        marginHeight="0"
        marginWidth="0"
        src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Sri%20Sivasubramaniya%20Nadar%20College%20of%20Engineering%20-%20College%20SH%2049A%20Kalavakkam,%20Tamil%20Nadu%20603110+(SSN%20College%20of%20Engineering)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        allowFullScreen
      >
      </iframe>
    </div>
